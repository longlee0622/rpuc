...
inline RCA::RCA(int seqNo)
	...
	PseudoRCAFlag(0),
	PseudoRCAMode(0),
	ssramInBaseAddr(10000),
	ssramInTopAddr(-1),
	ssramOutBaseAddr(10000),
	ssramOutTopAddr(-1),
	ssramTempOutBaseAddr(10000),
	ssramTempOutTopAddr(-1),
	ssramTempInBaseAddr(10000),
	ssramTempInTopAddr(-1),
	RemapFlag(false),
	MappedFlag(false),
	TooManyFlag(false),
	RIMoutMode(-1){
...
inline RCA::RCA(const RCA & rca)
	...
	ssramTempInBaseAddr(rca.ssramTempInBaseAddr),
	ssramTempInTopAddr(rca.ssramTempInTopAddr),
