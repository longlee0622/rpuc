...
int RPUConfig::genGroupContext()
{
...
#if 0   //for RCA interface and patch
	const String headFileName = "RCA_Port_Interface.h";

	const String patchFileName = "RCA_Execution_patch.h";



	//2011.6.19 liuxie for interface File
	std::ofstream headFile(headFileName.c_str());
	assert(headFile);
	...
	headFile<<
		"/******************************************************\n"
		" * This file is generated by DFGCompiler automatically.\n"
		" * ----------------------------------------------------\n"
		" * This file include some necessary macro definition.\n"
		" */\n"<<std::endl;
	...
	patchFile<<
		...
		"\n"
		"\n"
		"#include \"RCAExec/_RCAExec.h\"\n"
		"#include \""<<graphName<<"_config.h\"\n"
		"#include \""<<graphName<<"_interface.h\"\n"
		"\n"
		"\n"
		"#define DMA_CTL        0xA0000051\n"
		"#define DIN_BASIC_CTL  336\n"
		"\n"
		"\n"
		"extern short array_in[];\n"
		"extern short array_out[];\n"
		"\n"
		"// Function definition begin\n"
		"#define "<<GRAPHNAME<<"_FLAG    1\n\n";
	...
	{    
		...
		for(int i =0; i <(MAX_CL1_RCA_NUM - MappedRCA) ; ++ i)
		{
			...
			*/
			...
			for(portIter = RCAInport.begin();portIter != RCAInport.end(); ++ portIter) 
			{
				if(!(IsInnerPort(portIter->dfgPort())) && !(IsTempExternPort(portIter->dfgPort())))  //既不是innerPort也不是ExternTempPort,才是outPort
				{
						ExternPortRecord = true;
						break;
				}
